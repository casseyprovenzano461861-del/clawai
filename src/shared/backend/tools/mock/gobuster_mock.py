...
def main():
    """主函数"""
    if len(sys.argv) < 2:
        print(f"Gobuster模拟工具 v1.0.0")
        print(f"描述: 目录/文件暴力破解工具")
        print(f"能力: 目录枚举, 文件发现, 子域名枚举")
        print("\n使用示例:")
        print(f"  python gobuster_mock.py <目标>")
        print(f"  python gobuster_mock.py example.com")
        return
